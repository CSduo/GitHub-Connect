export function LotusIcon({ size = 24, className = "", opacity = 1 }: { size?: number; className?: string; opacity?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true" style={{ opacity }}>
...
export function OrnateCorner({ className = "" }: { className?: string }) {
  return (
...
export function TrishulIcon({ size = 20, className = "" }: { size?: number; className?: string }) {
  return (
...
export function MandalaRing({ size = 48, className = "", spin = false }: { size?: number; className?: string; spin?: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={`${className} ${spin ? "animate-spin-slow" : ""}`} aria-hidden="true">
